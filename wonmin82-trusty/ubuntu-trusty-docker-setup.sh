...
install_prerequisites()
{
	...
	retry sudo aptitude -y --with-recommends --download-only install apt-transport-https ca-certificates tasksel
	sudo aptitude -y --with-recommends install apt-transport-https ca-certificates tasksel
}
